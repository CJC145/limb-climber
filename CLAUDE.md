...
**Recorded exception (2026-09-23):** the ClimberV2 test rig is generated by
`tools/build_climber_v2.luau` at the human's explicit request, overriding the phase 2
handoff for that one task only. It does not relax the rule for anything else.
`assets/climber.rbxm` stays as the backup.
